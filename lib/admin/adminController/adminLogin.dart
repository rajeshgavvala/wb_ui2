...
import 'package:uiflutter/admin/adminLandingPage/adminWBHome.dart';
...
class _AdminLoginState extends State<AdminLogin> {
  ...
  Widget build(BuildContext context) {
          ...
          children: [
            ...
            TextSpan(
              ...
              recognizer: new TapGestureRecognizer()..onTap = () => {
                Navigator.pushNamed(context, '/wbapi/adminSignup')},
              style: TextStyle(
                color: Colors.blue[900],
                fontSize: 18.0,
    ...
    return new Scaffold(
      appBar: new AppBar(
        title: new Text("ProductAdmin...Page!"),
  ...
  signIn(String username, password) async {
    ...
    var response = await http.post(
      "http://192.168.0.108:8080/wbapi/auth/admin/login",
    ...
    if(response.statusCode == 200) {
      ...
      if(jsonResponse['accessToken']==null){
        ...
        Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (BuildContext context) => AdminWBHome()), (Route<dynamic> route) => false);
      }
    }
    else {
      setState(() {
